...
Crypto: Kyber1024 + Dilithium2 + AES-256-CTR
"""
import oqs
...
class PQCSender:
    def __init__(self):
        ...
        print("[SENDER] Configuration: Kyber1024 + Dilithium2")
        print("=" * 80)
        ...
        print("[SENDER] ✓ Kyber1024 ready")
        # ===== DILITHIUM2 SIGNATURE =====
        print("\n[SENDER] Initializing Dilithium2 signature...")
        self.sig = oqs.Signature("Dilithium2")
        self.sig_algo_name = "Dilithium2"
        print("[SENDER] ✓ Dilithium2 ready")
        # Generate signature keypair
        print("[SENDER] Generating Dilithium2 keypair...")
        self.sender_sig_public_key = self.sig.generate_keypair()
        self.sender_sig_secret_key = self.sig.export_secret_key()
        print(f"[SENDER] ✓ Dilithium2 keypair generated ({len(self.sender_sig_public_key)} bytes)")
        # ===== MQTT CLIENT SETUP =====
        print("\n[SENDER] Setting up MQTT client...")
        self.client = mqtt.Client(client_id="pqc_sender_k1024_d2")
    ...
    def start(self):
        ...
        print(f"[CONFIG] Crypto: Kyber1024 + Dilithium2 + AES-256-CTR")
