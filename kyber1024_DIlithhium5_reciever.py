...
"""
PQC IoT Receiver
Crypto: Kyber1024 + Dilithium5 + AES-256-CTR
...
class PQCReceiver:
    def __init__(self):
        ...
        print("[RECEIVER] Configuration: Kyber1024 + Dilithium5")
        print("[RECEIVER] ⚠️  MAXIMUM SECURITY CONFIGURATION ⚠️")
        print("=" * 80)
        ...
        print("[RECEIVER] ✓ Kyber1024 ready (NIST Level 5)")
        ...
        print("[RECEIVER] ✓ Dilithium5 ready (NIST Level 5)")
        ...
        self.client = mqtt.Client(client_id="pqc_receiver_k1024_d5")
    ...
    def print_summary(self):
        ...
        if n == 0:
            ...
            return
        print("\n" + "=" * 80)
        print("PERFORMANCE SUMMARY - Kyber1024 + Dilithium5 (MAXIMUM SECURITY)")
        print("=" * 80)
        # Calculate duration
    ...
    def start(self):
        ...
        print(f"[CONFIG] Crypto: Kyber1024 + Dilithium5 + AES-256-CTR")
        print(f"[CONFIG] Security: NIST Level 5 (MAXIMUM)")
        print("=" * 80)
