...
Crypto: Kyber512 + Dilithium2 + AES-256-CTR
"""
import oqs
...
LM35_ADC_CHANNEL = 0
READING_INTERVAL = 3 # seconds
class PQCSender:
    def __init__(self):
        print("=" * 80)
        print("[SENDER] Initializing PQC IoT Sender (Raspberry Pi 4)")
        print("[SENDER] Configuration: Kyber512 + Dilithium2")
        print("=" * 80)
        ...
        print("\n[SENDER] Initializing Kyber512 KEM...")
        self.kem = oqs.KeyEncapsulation("Kyber512")
        print("[SENDER] ✓ Kyber512 ready")
        ...
        self.client = mqtt.Client(client_id="pqc_sender_k512_d2")
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            ...
            if msg.topic == TOPIC_KYBER_PK:
                ...
                print(f"\n[MQTT] ✓ Received Kyber512 public key ({len(self.kyber_public_key)} bytes)")
    ...
    def encrypt_and_send_data(self, lm35_temp, dht11_temp, dht11_humidity):
        ...
        try:
            ...
            print(
                ...
                f"K512={t_kyber_enc_ms:.2f}ms AES={t_aes_enc_ms:.2f}ms "
    ...
    def start(self):
        ...
        print(f"[CONFIG] Crypto: Kyber512 + Dilithium2 + AES-256-CTR")
        ...
        print("[MQTT] Waiting for receiver's Kyber512 public key...")
