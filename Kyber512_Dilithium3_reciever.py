...
"""
PQC IoT Receiver
Crypto: Kyber512 + Dilithium3 + AES-256-CTR
"""
import oqs
...
class PQCReceiver:
    def __init__(self):
        ...
        print("[RECEIVER] Configuration: Kyber512 + Dilithium3")
        print("=" * 80)
        ...
        self.client = mqtt.Client(client_id="pqc_receiver_k512_d3")
    ...
    def print_summary(self):
        ...
        if n == 0:
            ...
            return
        print("\n" + "=" * 80)
        print("PERFORMANCE SUMMARY - Kyber512 + Dilithium3")
        print("=" * 80)
        # Calculate duration
    ...
    def start(self):
        ...
        print(f"[CONFIG] Crypto: Kyber512 + Dilithium3 + AES-256-CTR")
        print("=" * 80)
