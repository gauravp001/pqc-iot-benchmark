...
class PQCSender:
    def __init__(self):
        ...
        print("[SENDER] Configuration: Kyber1024 + Dilithium5")
        print("[SENDER] ⚠️  MAXIMUM SECURITY CONFIGURATION ⚠️")
        print("=" * 80)
        ...
        print("\n[SENDER] Initializing Kyber1024 KEM...")
        self.kem = oqs.KeyEncapsulation("Kyber1024")
        print("[SENDER] ✓ Kyber1024 ready (NIST Level 5)")
        # ===== DILITHIUM5 SIGNATURE =====
        print("\n[SENDER] Initializing Dilithium5 signature...")
        self.sig = oqs.Signature("Dilithium5")
        self.sig_algo_name = "Dilithium5"
        print("[SENDER] ✓ Dilithium5 ready (NIST Level 5)")
        # Generate signature keypair
        print("[SENDER] Generating Dilithium5 keypair...")
        self.sender_sig_public_key = self.sig.generate_keypair()
        self.sender_sig_secret_key = self.sig.export_secret_key()
        print(f"[SENDER] ✓ Dilithium5 keypair generated ({len(self.sender_sig_public_key)} bytes)")
        # ===== MQTT CLIENT SETUP =====
        print("\n[SENDER] Setting up MQTT client...")
        self.client = mqtt.Client(client_id="pqc_sender_k1024_d5")
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            ...
            if msg.topic == TOPIC_KYBER_PK:
                ...
                print(f"\n[MQTT] ✓ Received Kyber1024 public key ({len(self.kyber_public_key)} bytes)")
    ...
    def encrypt_and_send_data(self, lm35_temp, dht11_temp, dht11_humidity):
        ...
        try:
            ...
            sensor_data = {
                "sensor_id": "RPI4_K1024_D5_MAX_SEC",
            ...
            print(
                ...
                f"K1024={t_kyber_enc_ms:.2f}ms AES={t_aes_enc_ms:.2f}ms "
                f"D5={t_sign_ms:.2f}ms"
            )
        except Exception as e:
    ...
    def start(self):
        ...
        print("[MQTT] Waiting for receiver's Kyber1024 public key...")
