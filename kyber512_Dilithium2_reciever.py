...
class PQCReceiver:
    def __init__(self):
        ...
        print("[RECEIVER] Configuration: Kyber512 + Dilithium2")
        print("=" * 80)
        ...
        print("\n[RECEIVER] Initializing Dilithium2 signature...")
        self.sig = oqs.Signature("Dilithium2")
        self.sig_algo_name = "Dilithium2"
        print("[RECEIVER] ✓ Dilithium2 ready")
        ...
        self.client = mqtt.Client(client_id="pqc_receiver_k512_d2")
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            ...
            if msg.topic == TOPIC_ENCRYPTED_DATA:
                ...
                print(f"{'='*80}")
                print(f"  ✓ Dilithium2: VERIFIED ({t_sig_ms:.3f}ms)")
    ...
    def print_summary(self):
        ...
        if n == 0:
            ...
            return
        print("\n" + "=" * 80)
        print("PERFORMANCE SUMMARY - Kyber512 + Dilithium2")
        print("=" * 80)
        # Calculate duration
        ...
        if self.t_sig_list:
            show_stats("Signature Verification (Dilithium2)", self.t_sig_list)
        ...
        if self.t_sign_enc_list:
            show_stats("Signature Generation (Dilithium2)", self.t_sign_enc_list)
        # Message sizes
        total_sizes = [
            c + e + s
